...
{
    co_return co_await pipeline_.async_execute<types::account_information_t>(account_information_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::futures_account_balance_t>>(account_balances_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::account_config_response_t>(account_config_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::multi_assets_mode_response_t>(get_multi_assets_mode_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::position_mode_response_t>(get_position_mode_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::rate_limit_t>>(rate_limit_order_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::bnb_burn_status_response_t>(get_bnb_burn_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::download_id_response_t>(download_id_transaction_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::download_link_response_t>(download_link_transaction_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::download_id_response_t>(download_id_order_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::download_link_response_t>(download_link_order_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::download_id_response_t>(download_id_trade_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<types::download_link_response_t>(download_link_trade_endpoint.method,

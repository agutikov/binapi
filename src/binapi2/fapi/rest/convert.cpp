...
{
    query_map query{ { "fromAsset", request.fromAsset }, { "toAsset", request.toAsset } };
    if (request.fromAmount) {
        query["fromAmount"] = *request.fromAmount;
    }
    if (request.toAmount) {
        query["toAmount"] = *request.toAmount;
    }
...
{
    query_map query{ { "quoteId", request.quoteId } };

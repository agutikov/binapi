...
{
    co_return co_await pipeline_.async_execute<std::vector<types::kline_t>>(
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::kline_t>>(mark_price_klines_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::kline_t>>(premium_index_klines_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::book_ticker_t>>(
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::price_ticker_t>>(
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::price_ticker_t>>(price_ticker_v2_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::ticker_24hr_t>>(
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::mark_price_t>>(
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::funding_rate_info_t>>(funding_rate_info_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::open_interest_statistics_entry_t>>(
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::long_short_ratio_entry_t>>(top_long_short_account_ratio_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::long_short_ratio_entry_t>>(top_trader_long_short_ratio_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::long_short_ratio_entry_t>>(long_short_ratio_endpoint.method,
...
{
    co_return co_await pipeline_.async_execute<std::vector<types::taker_buy_sell_volume_entry_t>>(taker_buy_sell_volume_endpoint.method,

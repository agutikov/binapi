...
#define __BINAPI_GET2(obj, member, json) __get_json(obj.member, #member, json)
...
ping_t
ping_t::construct(const flatjson::fjson& json)
{
...
std::ostream&
operator<<(std::ostream& os, const ping_t& o)
{
    os << "{"
...
server_time_t
server_time_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const server_time_t& o)
{
    os << "{"
...
avg_price_t
avg_price_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const avg_price_t& o)
{
    os << "{"
       << "\"mins\":" << o.mins << ","
       << "\"price\":\"" << o.price << "\""
...
prices_t::price_t
prices_t::price_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const prices_t::price_t& o)
{
    os << "{"
       << "\"symbol\":\"" << o.symbol << "\","
       << "\"price\":\"" << o.price << "\""
...
prices_t
prices_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const prices_t& o)
{
    os << "[";
...
bool
prices_t::is_valid_symbol(const char* sym) const
{
...
std::ostream&
operator<<(std::ostream& os, const _24hrs_tickers_t::_24hrs_ticker_t& f)
{
    os << "{"
       << "\"symbol\":\"" << f.symbol << "\","
...
_24hrs_tickers_t
_24hrs_tickers_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const _24hrs_tickers_t& f)
{
    os << "[";
...
account_info_t::balance_t
account_info_t::balance_t::construct(const flatjson::fjson& json)
{
    (void)json;
...
std::ostream&
operator<<(std::ostream& os, const account_info_t::balance_t& o)
{
    os << "{"
       << "\"asset\":\"" << o.asset << "\","
       << "\"free\":\"" << o.free << "\","
...
account_info_t
account_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
const double_type&
account_info_t::add_balance(const char* symbol, const double_type& amount)
{
    auto it = balances.find(symbol);
    if (it != balances.end()) {
...
const double_type&
account_info_t::sub_balance(const char* symbol, const double_type& amount)
{
    auto it = balances.find(symbol);
    if (it != balances.end()) {
        it->second.free -= amount;
...
std::ostream&
operator<<(std::ostream& os, const account_info_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::rate_limit_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::price_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::percent_price_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::percent_price_by_side_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::lot_size_t& o)
{
    os << "{"
       << "\"filterType\":\"LOT_SIZE\","
       << "\"minQty\":\"" << o.minQty << "\","
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::market_lot_size_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::min_notional_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::iceberg_parts_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::max_num_orders_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::max_num_algo_orders_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::max_position_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::trailing_delta_t& o)
{
    os << "{"
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t::notional_t& o)
{
    os << "{"
       << "\"filterType\":\"NOTIONAL\","
       << "\"minNotional\":\"" << o.minNotional << "\","
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t::filter_t& o)
{
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t::symbol_t& o)
{
    os << "{"
       << "\"symbol\":\"" << o.symbol << "\","
       << "\"status\":\"" << o.status << "\","
...
bool
exchange_info_t::is_valid_symbol(const char* sym) const
{
...
exchange_info_t
exchange_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const exchange_info_t& o)
{
    os << "{"
       << "\"timezone\":\"" << o.timezone << "\","
       << "\"serverTime\":" << o.serverTime << ","
    ...
    os << "],";
    static const std::size_t perms_arr[] = { static_cast<std::underlying_type<e_permissions>::type>(e_permissions::NONE),
                                             ...
                                             static_cast<std::underlying_type<e_permissions>::type>(
                                                 e_permissions::TRD_GRP_005) };
...
std::ostream&
operator<<(std::ostream& os, const depths_t::depth_t& o)
{
    os << "["
       << "\"" << o.price << "\","
       << "\"" << o.amount << "\","
...
depths_t
depths_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const depths_t& o)
{
    os << "{"
...
trades_t::trade_t
trades_t::trade_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const trades_t::trade_t& o)
{
    os << "{"
       << "\"id\":" << o.id << ","
       << "\"price\":\"" << o.price << "\","
...
trades_t
trades_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const trades_t& o)
{
    os << "[";
...
agg_trades_t::agg_trade_t
agg_trades_t::agg_trade_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const agg_trades_t::agg_trade_t& o)
{
    os << "{"
       << "\"id\":" << o.id << ","
       << "\"price\":\"" << o.price << "\","
...
agg_trades_t
agg_trades_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const agg_trades_t& o)
{
    os << "[";
    for (auto it = o.trades.begin(); it != o.trades.end(); ++it) {
        os << *it;
...
std::ostream&
operator<<(std::ostream& os, const klines_t::kline_t& o)
{
    os << "[" << o.start_time << ","
       << "\"" << o.open << "\","
       << "\"" << o.high << "\","
...
klines_t
klines_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const klines_t& o)
{
    os << "[";
...
order_info_t
order_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const order_info_t& o)
{
    os << "{"
       << "\"symbol\":\"" << o.symbol << "\","
       << "\"orderId\":" << o.orderId << ","
...
orders_info_t
orders_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const orders_info_t& o)
{
    os << "[";
...
new_order_info_ack_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
new_order_info_result_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
double_type
new_order_info_full_t::avg_price(const std::vector<fill_part>& parts)
{
    double_type res{};
...
double_type
new_order_info_full_t::sum_amount(const std::vector<fill_part>& parts)
{
    double_type res{};
    for (const auto& it : parts) {
        res += it.qty;
...
double_type
new_order_info_full_t::sum_commission(const std::vector<fill_part>& parts)
{
    double_type res{};
    for (const auto& it : parts) {
        res += it.commission;
...
new_order_info_full_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const new_order_resp_type& o)
{
...
new_test_order_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
    assert(json.is_object());
...
std::ostream&
operator<<(std::ostream& os, const new_test_order_info_t& o)
{
...
cancel_order_info_t
cancel_order_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const cancel_order_info_t& o)
{
    os << "{"
       << "\"symbol\":\"" << o.symbol << "\","
       << "\"orderId\":" << o.orderId << ","
...
cancel_all_open_orders_info_t
cancel_all_open_orders_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const cancel_all_open_orders_info_t& o)
{
    os << "[";
...
my_trades_info_t::my_trade_info_t
my_trades_info_t::my_trade_info_t::construct(const flatjson::fjson& json)
{
    my_trade_info_t res{};
    __BINAPI_GET(symbol);
    __BINAPI_GET(id);
...
std::ostream&
operator<<(std::ostream& os, const my_trades_info_t::my_trade_info_t& o)
{
    os << "{"
       << "\"symbol\":\"" << o.symbol << "\","
       << "\"id\":" << o.id << ","
...
my_trades_info_t
my_trades_info_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const my_trades_info_t& o)
{
    os << "[";
    for (auto it = o.trades.begin(); it != o.trades.end(); ++it) {
        os << *it;
...
start_user_data_stream_t
start_user_data_stream_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const start_user_data_stream_t& o)
{
    os << "{"
...
ping_user_data_stream_t
ping_user_data_stream_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const ping_user_data_stream_t& o)
{
    os << "{"
       << "\"ok\":" << (o.ok ? "true" : "false") << "}";
...
close_user_data_stream_t
close_user_data_stream_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const close_user_data_stream_t& o)
{
    os << "{"
       << "\"ok\":" << (o.ok ? "true" : "false") << "}";
...
agg_trade_t
agg_trade_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const agg_trade_t& o)
{
    os << "{"
       << "\"e\":\"" << o.e << "\","
       << "\"E\":" << o.E << ","
...
trade_t
trade_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const trade_t& o)
{
    os << "{"
       << "\"E\":" << o.E << ","
       << "\"s\":\"" << o.s << "\","
...
std::ostream&
operator<<(std::ostream& os, const part_depths_t::depth_t& o)
{
    (void)o;
...
part_depths_t
part_depths_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const part_depths_t& o)
{
    os << "{"
       << "\"asks\":[";
...
std::ostream&
operator<<(std::ostream& os, const diff_depths_t::depth_t& o)
{
    (void)o;
...
diff_depths_t
diff_depths_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const diff_depths_t& o)
{
    os << "{"
       << "\"E\":" << o.E << ","
       << "\"s\":\"" << o.s << "\","
...
kline_t
kline_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const kline_t& o)
{
    os << "{"
       << "\"E\": " << o.E << ","
       << "\"s\": \"" << o.s << "\","
...
bool
ohlc_equal(const kline_t& l, const kline_t& r)
{
    return l.o == r.o && l.h == r.h && l.l == r.l && l.c == r.c;
}

std::ostream&
ohlc(std::ostream& os, const kline_t& o)
{
    os << "{"
       << "\"o\": \"" << o.o << "\","
       << "\"h\": \"" << o.h << "\","
...
mini_ticker_t
mini_ticker_t::construct(const flatjson::fjson& json)
{
    mini_ticker_t res{};
    __BINAPI_GET(E);
    __BINAPI_GET(s);
...
std::ostream&
operator<<(std::ostream& os, const mini_ticker_t& o)
{
    os << "{"
       << "\"E:\"" << o.E << ","
       << "\"s\":\"" << o.s << "\","
...
mini_tickers_t
mini_tickers_t::construct(const flatjson::fjson& json)
{
    assert(json.is_array());
...
std::ostream&
operator<<(std::ostream& os, const mini_tickers_t& o)
{
    os << "[";
...
market_ticker_t
market_ticker_t::construct(const flatjson::fjson& json)
{
    market_ticker_t res{};
    __BINAPI_GET(E);
    __BINAPI_GET(s);
...
std::ostream&
operator<<(std::ostream& os, const market_ticker_t& o)
{
    os << "{"
       << "\"E\":" << o.E << ","
       << "\"s\":\"" << o.s << "\","
...
markets_tickers_t
markets_tickers_t::construct(const flatjson::fjson& json)
{
    assert(json.is_array());
...
std::ostream&
operator<<(std::ostream& os, const markets_tickers_t& o)
{
    os << "[";
    for (auto it = o.tickers.begin(); it != o.tickers.end(); ++it) {
        os << it->second;
...
book_ticker_t
book_ticker_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const book_ticker_t& o)
{
    os << "{"
       << "\"u\":" << o.u << ","
       << "\"s\":\"" << o.s << "\","
...
std::ostream&
operator<<(std::ostream& os, const account_update_t::balance_t& o)
{
    os << "{"
       << "\"a\":\"" << o.a << "\","
       << "\"f\":\"" << o.f << "\","
...
account_update_t
account_update_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const account_update_t& o)
{
    os << "{"
       << "\"e\":\"" << o.e << "\","
       << "\"E\":" << o.E << ","
...
balance_update_t
balance_update_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const balance_update_t& o)
{
    os << "{"
       << "\"e\":\"" << o.e << "\","
       << "\"E\":" << o.E << ","
...
order_update_t
order_update_t::construct(const flatjson::fjson& json)
{
    assert(json.is_valid());
...
std::ostream&
operator<<(std::ostream& os, const order_update_t& o)
{
    os << "{"
       << "\"e\":\"" << o.e << "\","
       << "\"E\":" << o.E << ","
...
userdata_stream_t
userdata_stream_t::construct(const flatjson::fjson& json)
{
...
std::ostream&
operator<<(std::ostream& os, const userdata_stream_t& o)
{
    (void)o;

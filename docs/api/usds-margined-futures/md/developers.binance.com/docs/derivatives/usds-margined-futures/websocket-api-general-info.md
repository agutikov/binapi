...
- **meta_description**: The base endpoint is//ws-fapi.binance.com/ws-fapi/v1*

## Introduction

- The base endpoint is: `wss://ws-fapi.binance.com/ws-fapi/v1` The base endpoint for testnet is: `wss://testnet.binancefuture.com/ws-fapi/v1`

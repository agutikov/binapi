...
- **description**: Top <levels> bids and asks, Valid <levels> are 5, 10, or 20.
- **url_path**: `/public`
- **stream_name**: `<symbol>@depth<levels>` OR `<symbol>@depth<levels>@500ms` OR `<symbol>@depth<levels>@100ms`.
- **update_speed**: 250ms, 500ms or 100ms

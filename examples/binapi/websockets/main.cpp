...
main()
{
    ...
    ws.klines("BTCUSDT", "1s", [](const char* fl, int ec, std::string emsg, auto klines) {
        if (ec) {
    ...
    ws.part_depth(
        "BTCUSDT", binapi::e_levels::_5, binapi::e_freq::_100ms, [](const char* fl, int ec, std::string emsg, auto depths) {
            if (ec) {
    ...
    ws.diff_depth("BTCUSDT", binapi::e_freq::_100ms, [](const char* fl, int ec, std::string emsg, auto depths) {
        if (ec) {
    ...
    ws.trade("BTCUSDT", [](const char* fl, int ec, std::string emsg, auto trades) {
        if (ec) {
    ...
    auto book_handler = ws.book("BTCUSDT", [](const char* fl, int ec, std::string emsg, auto book) {
        if (ec) {
    ...
    ws.mini_tickers([](const char* fl, int ec, std::string emsg, auto mini_tickers) {
        if (ec) {

...
Implement a new USD-M Futures client library under [`include/binapi2/fapi`](/include/binapi2/fapi), [`src/binapi2/fapi`](/src/binapi2/fapi), and [`examples/binapi2/fapi`](/examples/binapi2/fapi).
...
- examples in [`examples/binapi2/fapi`](/examples/binapi2/fapi)
...
- [`http_client.hpp`](/include/binapi2/fapi/transport/http_client.hpp) will wrap HTTPS request execution over Boost.Beast.
- [`websocket_client.hpp`](/include/binapi2/fapi/transport/websocket_client.hpp) will wrap websocket handshake, reads, writes, ping handling, reconnect hooks, and close semantics.
- Shared SSL and resolver setup should live behind [`ssl_context.hpp`](/include/binapi2/fapi/transport/ssl_context.hpp) and [`session_base.hpp`](/include/binapi2/fapi/transport/session_base.hpp).
...
- Generated metadata declarations can live in [`generated_endpoints.hpp`](/include/binapi2/fapi/rest/generated_endpoints.hpp) and [`generated_methods.hpp`](/include/binapi2/fapi/websocket_api/generated_methods.hpp).

#### Type system

- Define plain C++ structs for every documented request, response, and event payload.
- Group types by domain in [`types/`](/include/binapi2/fapi/types).
...
- Provide a main REST facade in [`client.hpp`](/include/binapi2/fapi/client.hpp) with domain subclients or grouped member functions.
...
```cpp
binapi2::fapi::client client{cfg};
auto result = client.new_order(binapi2::fapi::types::new_order_request{...});
```
...
- extend [`/CMakeLists.txt`](/CMakeLists.txt) with a new [`binapi2`](/CMakeLists.txt) target or a dedicated [`binapi2_fapi`](/CMakeLists.txt) library target
- keep original [`binapi`](/) target intact to avoid breaking current consumers
- add example targets under [`examples/binapi2/fapi`](/examples/binapi2/fapi)
...
- define namespace layout under `binapi2::fapi`
...
- [`binapi2::fapi`](/include/binapi2/fapi) exists as a new typed client library parallel to the original [`binapi`](/)

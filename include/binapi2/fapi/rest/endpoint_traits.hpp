...
{
    using response_type = types::empty_response;
...
{
    using response_type = types::server_time_response;
...
{
    using response_type = types::exchange_info_response;
...
{
    using response_type = types::order_book_response;
...
{
    using response_type = std::vector<types::recent_trade>;
...
{
    using response_type = std::vector<types::aggregate_trade>;
...
{
    using response_type = std::vector<types::kline>;
...
{
    using response_type = types::ticker_24hr;
...
{
    using response_type = types::mark_price;
...
{
    using response_type = std::vector<types::funding_rate_history_entry>;
...
{
    using response_type = types::open_interest;
...
{
    using response_type = std::vector<types::basis_entry>;
...
{
    using response_type = std::vector<types::delivery_price_entry>;
...
{
    using response_type = std::vector<types::composite_index_info>;
...
{
    using response_type = types::index_constituents_response;
...
{
    using response_type = std::vector<types::asset_index>;
...
{
    using response_type = types::insurance_fund_response;
...
{
    using response_type = std::vector<types::adl_risk_entry>;
...
{
    using response_type = types::trading_schedule_response;
...
{
    using response_type = std::vector<types::symbol_config_entry>;
...
{
    using response_type = std::vector<types::income_history_entry>;
...
{
    using response_type = std::vector<types::symbol_leverage_brackets>;
...
{
    using response_type = types::commission_rate_response;
...
{
    using response_type = types::bnb_burn_status_response;
...
{
    using response_type = types::quantitative_rules_response;
...
{
    using response_type = types::pm_account_info_response;
...
{
    using response_type = types::auto_cancel_response;
...
{
    using response_type = std::vector<types::order_response>;
...
{
    using response_type = std::vector<types::position_risk_v3>;
...
{
    using response_type = std::vector<types::adl_quantile_entry>;
...
{
    using response_type = std::vector<types::account_trade_entry>;
...
{
    using response_type = types::change_leverage_response;
...
{
    using response_type = types::modify_isolated_margin_response;
...
{
    using response_type = std::vector<types::position_margin_history_entry>;
...
{
    using response_type = std::vector<types::algo_order_response>;
...
{
    using response_type = types::convert_quote_response;
...
{
    using response_type = types::convert_accept_response;
...
{
    using response_type = types::convert_order_status_response;

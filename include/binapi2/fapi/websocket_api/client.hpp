...
public:
    ...
    [[nodiscard]] result<types::websocket_api_response_t<types::session_logon_result_t>> session_logon();
    ...
    [[nodiscard]] result<types::websocket_api_response_t<types::account_information_t>> account_status();
    ...
    [[nodiscard]] result<types::websocket_api_response_t<types::account_information_t>> account_status_v2();
    ...
    [[nodiscard]] result<types::websocket_api_response_t<std::vector<types::futures_account_balance_t>>> account_balance();
    ...
    [[nodiscard]] result<types::websocket_api_response_t<std::vector<types::position_risk_t>>>
    account_position_v2(const types::websocket_api_position_request_t& request);
    ...
    [[nodiscard]] result<types::websocket_api_response_t<types::websocket_api_listen_key_result_t>> user_data_stream_start();
    ...
    [[nodiscard]] result<types::websocket_api_response_t<types::websocket_api_listen_key_result_t>> user_data_stream_ping();
    ...
    [[nodiscard]] result<types::websocket_api_response_t<types::empty_response_t>> user_data_stream_stop();
    ...
    using book_ticker_request_t = types::websocket_api_book_ticker_request_t;          ///< Alias for book ticker request type.
    using price_ticker_request_t = types::websocket_api_price_ticker_request_t;        ///< Alias for price ticker request type.
    using order_place_request = types::websocket_api_order_place_request_t;          ///< Alias for order placement request type.
    using order_query_request = types::websocket_api_order_query_request_t;          ///< Alias for order query request type.
    using order_cancel_request = types::websocket_api_order_cancel_request_t;        ///< Alias for order cancellation request type.
    using order_modify_request = types::websocket_api_order_modify_request_t;        ///< Alias for order modification request type.
    using position_request = types::websocket_api_position_request_t;                ///< Alias for position query request type.
    using algo_order_place_request = types::websocket_api_algo_order_place_request_t;  ///< Alias for algo order placement request type.

...
public:
    symbol_t() = default;
    symbol_t(const char* s) : value_(s) {}                           // NOLINT(google-explicit-constructor)
    symbol_t(std::string s) : value_(std::move(s)) {}                // NOLINT(google-explicit-constructor)
    symbol_t(std::string_view s) : value_(s) {}                      // NOLINT(google-explicit-constructor)

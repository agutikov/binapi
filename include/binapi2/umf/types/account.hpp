...
template <>
struct glz::meta<binapi2::umf::types::account_asset> {
    using T = binapi2::umf::types::account_asset;
...
template <>
struct glz::meta<binapi2::umf::types::account_position> {
    using T = binapi2::umf::types::account_position;
    static constexpr auto value = object(
        "symbol", &T::symbol,
        "initialMargin", &T::initialMargin,
        "maintMargin", &T::maintMargin,
        ...
        "bidNotional", &T::bidNotional,
        "askNotional", &T::askNotional,
...
template <>
struct glz::meta<binapi2::umf::types::account_information> {
    using T = binapi2::umf::types::account_information;
    static constexpr auto value = object(
        "feeTier", &T::feeTier,
        "canTrade", &T::canTrade,
        ...
        "updateTime", &T::updateTime,
        "multiAssetsMargin", &T::multiAssetsMargin,
...
template <>
struct glz::meta<binapi2::umf::types::futures_account_balance> {
    using T = binapi2::umf::types::futures_account_balance;
    static constexpr auto value = object(
...
template <>
struct glz::meta<binapi2::umf::types::position_risk> {
    using T = binapi2::umf::types::position_risk;
    static constexpr auto value = object(
        "symbol", &T::symbol,
        "positionAmt", &T::positionAmt,
        "entryPrice", &T::entryPrice,
        ...
        "isolatedMargin", &T::isolatedMargin,
        "isAutoAddMargin", &T::isAutoAddMargin,
        "positionSide", &T::positionSide,
        "notional", &T::notional,
        "isolatedWallet", &T::isolatedWallet,
        "updateTime", &T::updateTime
